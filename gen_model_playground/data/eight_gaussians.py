...
class EightGaussiansDataModule(pl.LightningDataModule):
    """
    ...
    def generate_dataset(self):
        ...
        """
        # Create the dataset
        X = sample_8gaussians(n=self.num_batches * self.batch_size)
        X = X.float()
        ...
        self.dataset = TensorDataset(X, torch.zeros(X.shape[0], dtype=torch.long))
...
if __name__ == "__main__":
    datamodule = EightGaussiansDataModule(batch_size=256)
    datamodule.setup()
